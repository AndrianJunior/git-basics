...
if (time >= 0 and time < 10) or (time >12 and time <= 14) or (time > 15 and time <= 18)\
        or (time > 20 and time <= 22):
...
#Вариант 1
#time = int(input("Введите время от 0 до 23:"))
#if (time >= 8 and time < 10) or (time >=12 and time < 14) or (time >= 15 and time < 18)\
#       or (time >= 20 and time < 22):
