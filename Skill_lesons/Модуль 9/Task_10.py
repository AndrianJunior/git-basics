...
move = input("Введите зашифрованное сообщение: ")
count=0
sum_letter1 = ""
sum_letter2 = ""
text = ""
for symbol in move:
    ...
    if count % 2 != 0:
        ...
        sum_letter2 = symbol + sum_letter2
text = sum_letter1 + sum_letter2
# print(count)
# print(letter_odd+letter_even[::-1])
# print(sum_letter1+sum_letter2)
# print(letter_odd)
# print(text)
